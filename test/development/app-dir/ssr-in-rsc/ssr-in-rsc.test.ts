        ...
        expect(redbox).toMatchInlineSnapshot(`
         {
           ...
           "source": "app/exports/app-code/react-dom-server-node-explicit/page.js (1:1) @ <unknown>
    ...
    if (isTurbopack) {
      if (isReact18) {
        ...
        expect(redbox).toMatchInlineSnapshot(`
         {
           "description": "react-dom/server is not supported in React Server Components.",
           "source": "internal-pkg/server.node.js (1:1) @ module.exports.__turbopack_context__.s.default
