    ...
    describe('source-maps', () => {
      it('should work on RSC', async () => {
        ...
        if (isTurbopack) {
          ...
          expect(await getRedboxSource(browser)).toMatchInlineSnapshot(`
           "app/separate-file.ts (1:7) @ module.exports.__turbopack_context__.s.default
          ...
          expect(await getRedboxCallStack(browser)).toMatchInlineSnapshot(`
           [
             "module.exports.__turbopack_context__.s.default app/separate-file.ts (1:7)",
      ...
      it('should work on SSR', async () => {
        ...
        if (isTurbopack) {
          // TODO the function name should be hidden
          expect(await getRedboxSource(browser)).toMatchInlineSnapshot(`
           "app/separate-file.ts (1:7) @ <unknown>
          ...
          expect(await getRedboxCallStack(browser)).toMatchInlineSnapshot(`
           [
             "<unknown> app/separate-file.ts (1:7)",
